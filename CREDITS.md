...
- the JSON patches (`src/assets/conquestvanillavom/patches/*.json`),
...
The mod ships base-game Vintage Story textures (`src/assets/conquestvanillavom/textures/vanilla/…`,
